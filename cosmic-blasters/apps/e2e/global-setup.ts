...
const servers: ServerDef[] = [
  { name: "server", filter: "@cosmic-blasters/server", url: "http://127.0.0.1:8090/health" },
  // Vite binds to [::1] (IPv6) by default — poll localhost, not 127.0.0.1
  { name: "display", filter: "@cosmic-blasters/display", url: "http://localhost:3000" },
  { name: "controller", filter: "@cosmic-blasters/controller", url: "http://localhost:5174" },
];
